...
<body>
    ...
    <form action="eleccionHamburguesas" method="POST">
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="18%" class="inicio"><span class="inicio3">Hamburguesas</span></td>
    <td width="25%"><select name="hamburguesas">
        <%
            String menus = "hambueguesa"; String descripcion = "nomhambueguesa";
