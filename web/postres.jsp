...
<body>
    ...
    <form action="eleccionPostres" method="POST">
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="18%" class="inicio"><span class="inicio3">Postres</span></td>
    <td width="25%"><select name="postres">
        <%
            String menus = "postre"; String descripcion = "nompostre";
            for(int i=0;i<pizzas.hacerConsulta(menus, descripcion).size();i++){
             
            String dato= pizzas.hacerConsulta(menus, descripcion).get(i);
             %>
             <option><%=dato
  ...
  <tr align="center">
    <td colspan="2"><input name="aceptar" type="submit" value="Confirmar pedido" /></td>
  </tr>
  <tr align="center">
