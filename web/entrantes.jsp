...
String nombre= sesion.getAttribute("nombre").toString();
    ...
    <form action="eleccionEntrantes" method="POST">
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="18%" class="inicio"><span class="inicio3">Entrantes</span></td>
    <td width="25%"><select name="entrantes">
        <%
            String menus = "entrante"; String descripcion = "descripcion";
