...
<body>
    ...
    <form action="eleccionEnsaladas" method="POST">
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="18%" class="inicio"><span class="inicio3">Ensaladas</span></td>
    <td width="25%"><select name="ensaladas">
        <%
            String menus = "ensaladas"; String descripcion = "nomensaladas";
