...
<body>
    ...
    <form action="eleccionOfertas" method="POST">
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="18%" class="inicio"><span class="inicio3">Ofertas</span></td>
    <td width="25%"><select name="ofertas">
        <%
            String menus = "ofertas"; String descripcion = "descriptcion";
