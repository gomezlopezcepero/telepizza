...
<body>
    ...
    <form action="eleccionPizzas" method="POST">
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="18%" class="inicio"><span class="inicio3">Pizzas</span></td>
    <td width="25%"><select name="pizzas">
        <%
            String menus = "pizzas"; String descripcion = "nompizzas";
