...
<table width="100%" border="0">
  ...
  <tr>
    <td width="18%" class="inicio"><span class="inicio3">Pasta</span></td>
    <td width="25%"><select name="pasta">
        <%
            String menus = "pasta"; String descripcion = "descripcion";
